...
#######################################################################################################################
from architecture.new_gan1 import Discriminator
from architecture.new_gan1 import Generator
...
for epoch in range(num_epochs):
    ...
    for i, (images, labels) in enumerate(trainloader):
        ...
        generator.train()
        discriminator.train()
        d_loss = discriminator_train_step(cond_images, batch_size, discriminator, generator, d_optimizer, criterion,
                                          real_images)
